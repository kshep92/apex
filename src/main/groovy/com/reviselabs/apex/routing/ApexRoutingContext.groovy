...
class ApexRoutingContext implements ApplicationContextContainer {
  ...
  public <T> Form<T> getBodyForm(Class<T> type) {
    logger.warn("getBodyForm<T>: This only works for JSON body types at the moment. Will fix in subsequent release. Maybe.")
